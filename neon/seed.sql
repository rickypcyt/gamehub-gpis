...
('event-001', 'Gamescom 2026', 'La feria de videojuegos más grande de Europa con anuncios y demos jugables.', 'convention', '2026-08-21', '2026-08-25', 'Colonia, Alemania', 'https://www.gamescom.global', NOW()),
('event-002', 'Tokyo Game Show 2026', 'Convención anual de videojuegos en Japón con foco en títulos asiáticos.', 'convention', '2026-09-26', '2026-09-29', 'Tokio, Japón', 'https://tgs.nikkeibp.co.jp', NOW()),
('event-003', 'Lanzamiento: GTA VI', 'El tan esperado regreso de la serie Grand Theft Auto.', 'launch', '2026-10-26', NULL, 'Mundial', 'https://www.rockstargames.com/gta-vi', NOW()),
...
('event-005', 'Lanzamiento: Metroid Prime 4', 'El regreso de la serie tras años de desarrollo.', 'launch', '2026-03-21', NULL, 'Mundial', 'https://www.nintendo.com/metroid-prime-4', NOW()),
('event-006', 'GDC 2026', 'Game Developers Conference: conferencia para desarrolladores profesionales.', 'expo', '2026-03-17', '2026-03-21', 'San Francisco, EE.UU.', 'https://gdconf.com', NOW()),
('event-007', 'E3 2026', 'Electronic Entertainment Expo (si se confirma su regreso).', 'expo', '2026-06-10', '2026-06-13', 'Los Ángeles, EE.UU.', 'https://www.e3expo.com', NOW()),
('event-008', 'Lanzamiento: Hollow Knight: Silksong', 'La secuela del aclamado indie finalmente llega.', 'launch', '2026-06-30', NULL, 'Mundial', 'https://www.teamcherry.com.au', NOW())
ON CONFLICT (id) DO NOTHING;
